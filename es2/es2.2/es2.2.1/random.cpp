...
// xyz::xyz(unsigned int n){
//    if(n<=3 && n!=0) error=false; 
//    else error=true;
//    cerr << "Attezione! nel costruttore è stato inserito un numero maggiore di "
//    dir(3){false};
// }
...
unsigned int Random::discr(int N){ // generato un numero casuale fra 1 e N
...
// posizione Random::vers_3D(){
//    posizione v;
//    double phi=Rannyu(0,2*pi);
//    double theta=acos(1-2*Rannyu());
//    v.Setx(cos(phi)*sin(theta));
//    v.Sety(sin(phi)*sin(theta));
//    v.Setz(cos(theta));
//    return v;
// }
